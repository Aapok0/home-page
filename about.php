...
<section class='hero is-fullheight has-background'>
  ...
  <div class='hero-body'>
    <div class='container hero-text box has-text-centered background-1'>
      ...
      <h2 class='subtitle is-family-code'>Current work</h2>
      ...
      <h2 class='subtitle is-family-code'>Personal development</h2>
      <p class='block is-size-5 has-text-left'>
      ...
      <!-- Button to resume -->
      <div class='block'>
        <a href='resume.php'><button class='button is-link has-text-weight-semibold'>See my resume</button></a>
      </div>
