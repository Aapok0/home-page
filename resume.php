...
<section class='section container'>
  <h1 class='title has-text-centered is-size-1'>Resume</h1>
  <div class='columns'>
    <!-- First column start -->
    <div class='column box m-2 p-3 background-2 is-radiusless'>

      <!-- Education start -->
      <div class='box mb-3 background-1 is-radiusless'>
        <h1 class='title is-family-code'>Education</h1>
        <h2 class='subtitle is-family-code mt-1 mb-0 resume-subtitle'>Bachelor of Engineering</h2>
        <ul>
        ...
        <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>Bachelor of Ecience in Technology</h2>
        <ul>
      ...
      <div class='box background-1 is-radiusless'>
        <h1 class='title is-family-code'>Voluntary work</h1>
        <h2 class='subtitle is-family-code mt-1 mb-0 resume-subtitle'>Aalto University's Guild of Electrical Engineering</h2>
        <ul>
    ...
    <div class='column box m-2 p-3 background-2 is-radiusless'>
      ...
      <div class='box mb-3 background-1 is-radiusless'>
        ...
        <ul>
          ...
          <li class='ml-4 resume-item'>Helping with the deployment, training and support of new software and general IT support and office work.</li>
        </ul>

        <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>Documentation Specialist (Trainee)</h2>
        <ul>
          <li class='pt-4 is-family-code resume-item'>Gemalto Oy (Thales Group)</li>
          <li class='ml-4 resume-item'>8.2019 - 2.2020</li>
          <li class='ml-4 resume-item'>Read through existing company documentation and supplier documentation and rewrote them into a new platform.</li>
        </ul>

        <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>Newspaper Delivery</h2>
        <ul>
          <li class='pt-4 is-family-code resume-item'>Posti Group Oyj</li>
          <li class='ml-4 resume-item'>4.-5.2011, 4.-8.2012 and 6.-8.2013</li>
          <li class='ml-4 resume-item'>Delivered newspapers during the night using a delivery bicycle.</li>
        </ul>

        <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>ICT Technician</h2>
        <ul>
          <li class='pt-4 is-family-code resume-item'>Elan IT Resource Oyj</li>
          <li class='ml-4 resume-item'>3.2012</li>
          <li class='ml-4 resume-item'>Searched channels for digiboxes, and if needed, updated them during a cable network update and answered any questions customers had about it.</li>
        </ul>

        <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>Mover</h2>
        <ul>
          <li class='pt-4 is-family-code resume-item'>Muuttohaukat Ky</li>
          <li class='ml-4 resume-item'>6.2009 - 3.2010</li>
          <li class='ml-4 resume-item'>Included various moving jobs like moving people to new homes and moving furniture inside larger buildings like a school or a company (or out of it). </li>
        </ul>
      </div>
      <!-- Work experience end -->
