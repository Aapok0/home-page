    ...
    <div class='container box background-2'>
      ...
      <div class='columns'>
        ...
        <div class='column background-2'>
          ...
          <div class='box mb-5 background-1'>
            <h1 class='title is-family-code'>Certifications</h1>
            <h2 class='subtitle is-family-code mt-1 mb-0 resume-subtitle'>Microsoft Azure</h2>
            <ul>
            ...
            <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>GitHub</h2>
            <ul>
        ...
        <div class='column background-2'>
          ...
          <div class='box mb-5 background-1'>
            ...
            <h2 class='subtitle is-family-code mt-1 mb-0 resume-subtitle'>Junior DevOps Engineer</h2>
            <ul>
            ...
            <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>Trainee Consultant</h2>
            <ul>
              <li class='pt-4 is-family-code resume-item'>Eficode Oy</li>
            ...
            <h2 class='subtitle is-family-code mt-5 mb-0 resume-subtitle'>Office Secretary</h2>
            <ul>
