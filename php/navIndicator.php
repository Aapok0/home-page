<?php
  ...
  if ($pos1 != false) {
    echo "<a class=\"navbar-item is-open is-flex-direction-column is-justify-content-space-around\" href=\"index.php\"><img class=\"mb-1\" src=\"img/home-dark.png\" alt=\"Home\">Home</a>";
    echo $about;
    echo $resume;
    echo $skills;
    echo $interests;
    ...
    echo $home;
    echo "<a class=\"navbar-item is-open is-flex-direction-column is-justify-content-space-around\" href=\"about.php\"><img class=\"mb-1\" src=\"img/about-dark.png\" alt=\"About\">About</a>";
    echo $resume;
    echo $skills;
    echo $interests;
    echo $contacts;
    ...
    echo $home;
    echo $about;
    echo "<a class=\"navbar-item is-open is-flex-direction-column is-justify-content-space-around\" href=\"resume.php\"><img class=\"mb-1\" src=\"img/resume-dark.png\" alt=\"Resume\">Resume</a>";
    echo $skills;
    echo $interests;
    echo $contacts;
  }
    ...
    echo $about;
    echo $resume;
    echo "<a class=\"navbar-item is-open is-flex-direction-column is-justify-content-space-around\" href=\"skills.php\"><img class=\"mb-1\" src=\"img/skills-dark.png\" alt=\"Skills\">Skills</a>";
    echo $interests;
    echo $contacts;
  }
  else if ($pos5 != false) {
    ...
    echo $resume;
    echo $skills;
    echo "<a class=\"navbar-item is-open is-flex-direction-column is-justify-content-space-around\" href=\"interests.php\"><img class=\"mb-1\" src=\"img/interests-dark.png\" alt=\"Interests\">Interests</a>";
    echo $contacts;
  }
  else if ($pos6 != false) {
    echo $home;
    ...
    echo $skills;
    echo $interests;
    echo "<a class=\"navbar-item is-open is-flex-direction-column is-justify-content-space-around\" href=\"contacts.php\"><img class=\"mb-1\" src=\"img/contacts-dark.png\" alt=\"Contacts\">Contacts</a>";
  }
  else {
    echo $home;
    echo $about;
